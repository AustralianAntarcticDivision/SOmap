...
#'
#' @param x SOmap or SOmap_auto: object as returned by \code{SOmap}, \code{SOmap2}, or \code{SOmap_auto}
#'
...
SOgg <- function(x) {
    if (inherits(x, "SOmap")) {
        ...
        stop("x must be an SOmap/SOmap_auto object as generated by SOmap, SOmap2, or SOmap_auto")
    }
}
...
## gg-ifier for SOmap objects, not SOmap_auto. Any management layers will be passed so SOgg2_management for gg-ifying
