...
## this workaround is just ridiculous, and probably fragile, so hopefully the underlying issue gets resolved

#' Replacement ggplot functions
#'
#' There is an issue with the default graphics device under Windows and R 4.2.2, which prevents degree symbols being shown correctly (see <https://github.com/tidyverse/ggplot2/issues/5147> and <https://github.com/r-lib/ragg/issues/51>). This function provides a (hopefully temporary) workaround by using the Unicode degree symbol into the labels.
#'
#' @param ... : as for [ggplot2::geom_sf()] or [ggplot2::coord_sf()]
#'
#' @export
coord_sf_unicode <- function(...) {
    p <- ggplot2::coord_sf(...)
    p$setup_panel_params0 <- p$setup_panel_params
    p$setup_panel_params <- function(...) {
        out <- p$setup_panel_params0(...)
        out$graticule$degree_label <- lapply(out$graticule$degree_label, function(l) str2lang(gsub("\"[[:space:]]*\\*[[:space:]]*degree", "\ub0\"", deparse(l))))
        out
    }
    p
}
...
#' @export
#' @rdname coord_sf_unicode
geom_sf_unicode <- function(...) {
    out <- ggplot2::geom_sf(...)
    out[[2]] <- coord_sf_unicode(default = TRUE)
    out
}
...
SOgg_notauto <- function(x) {
    ...
    if (!is.null(x$coastline) && "coastline" %in% x$plot_sequence) {
        ...
        out$coastline <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, fill = x$coastline[[1]]$plotargs$col, col = x$coastline[[1]]$plotargs$border, inherit.aes = FALSE))
    ...
    if (!is.null(x$ice) && "ice" %in% x$plot_sequence) {
        ...
        out$ice <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, fill = x$ice[[1]]$plotargs$col, col = x$ice[[1]]$plotargs$border, inherit.aes = FALSE))
    ...
    if (!is.null(x$fronts) && "fronts" %in% x$plot_sequence) {
        ...
        out$fronts <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = thiscol, inherit.aes = FALSE))
...
SOgg_management <- function(x, basemap) {
    ...
    if (!is.null(x$ccamlr_statistical_areas) && "ccamlr_statistical_areas" %in% x$plot_sequence) {
        ...
        out$ccamlr_statistical_areas <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$ccamlr_statistical_areas$main$plotargs$border,  inherit.aes = FALSE, fill = NA))#fill = x$ccamlr_statistical_areas$main$plotargs$col)
    ...
    if (!is.null(x$ccamlr_ssru) && "ccamlr_ssru" %in% x$plot_sequence) {
        ...
        out$ccamlr_ssru <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$ccamlr_ssru$main$plotargs$border, fill = x$ccamlr_ssru$main$plotargs$col, inherit.aes = FALSE))
    ...
    if (!is.null(x$ccamlr_ssmu) && "ccamlr_ssmu" %in% x$plot_sequence) {
        ...
        out$ccamlr_ssmu <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$ccamlr_ssmu$main$plotargs$border, fill = x$ccamlr_ssmu$main$plotargs$col, inherit.aes = FALSE))
    ...
    if (!is.null(x$research_blocks) && "research_blocks" %in% x$plot_sequence) {
        ...
        out$research_blocks <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$research_blocks$main$plotargs$border, fill = x$research_blocks$main$plotargs$col, inherit.aes = FALSE))
    ...
    if (!is.null(x$sprfmo_research_blocks) && "sprfmo_research_blocks" %in% x$plot_sequence) {
        ...
        out$sprfmo_research_blocks <- c(SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$sprfmo_research_blocks[[1]]$plotargs$col,  inherit.aes = FALSE)),
                                        SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = that, col = x$sprfmo_research_blocks[[2]]$plotargs$col,  inherit.aes = FALSE)))
    ...
    if (!is.null(x$eez) && "eez" %in% x$plot_sequence) {
        ...
        out$eez <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$eez$main$plotargs$border, fill = x$eez$main$plotargs$col, inherit.aes = FALSE))
    ...
    if (!is.null(x$mpa) && "mpa" %in% x$plot_sequence) {
        ...
        out$mpa <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$mpa$main$plotargs$border, fill = x$mpa$main$plotargs$col, inherit.aes = FALSE))
    ...
    if (!is.null(x$ccamlr_planning_domains) && "ccamlr_planning_domains" %in% x$plot_sequence) {
        ...
        out$ccamlr_planning_domains <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = this, col = x$ccamlr_planning_domains$main$plotargs$border, fill = x$ccamlr_planning_domains$main$plotargs$col, inherit.aes = FALSE))
...
SOgg_auto <- function(x) {
    ...
    if (!is.null(x$graticule) && "graticule" %in% x$plot_sequence) {
        out$graticule <- SO_plotter(plotfun = "geom_sf_unicode", plotargs = list(data = x$graticule[[1]]$plotargs$x, col = "grey", inherit.aes = FALSE))
        out$plot_sequence <- c(out$plot_sequence, "graticule")
    }
