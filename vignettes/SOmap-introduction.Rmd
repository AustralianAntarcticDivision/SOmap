...
## scale factor
f <- 3e6
plot(terra::project(lonlat, to = "+proj=laea +lat_0=-90 +datum=WGS84", from = "OGC:CRS84"), asp = 1, type = "l",
...
mp <- m
pxy <- terra::project(lonlat, to = "+proj=laea +lat_0=-90 +datum=WGS84", from = "OGC:CRS84")
mp$x <- pxy[,1]
mp$y <- pxy[,2]
...
mpmerc <- m
pxy <- terra::project(lonlat, to = "+proj=merc +datum=WGS84", from = "OGC:CRS84")
mpmerc$x <- pxy[,1]
mpmerc$y <- pxy[,2]
